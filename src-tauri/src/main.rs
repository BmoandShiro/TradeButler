...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::update_emotion_survey,
            commands::delete_emotion_survey_for_state,
            ...
            commands::get_strategy_survey_metrics,
            commands::get_strategy_survey_metrics_with_values,
            commands::save_strategy_survey_metric,
            commands::delete_strategy_survey_metric,
            commands::get_strategy_calculation_presets,
            commands::save_strategy_calculation_preset,
            commands::delete_strategy_calculation_preset,
            ...
            commands::test_finnhub_connection,
            commands::fetch_finnhub_earnings,
            commands::fetch_finnhub_earnings_batch,
            commands::fetch_finnhub_news,
            commands::fetch_finnhub_news_batch,
            commands::fetch_finnhub_basic_financials,
