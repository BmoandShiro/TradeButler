...
export default function Calendar() {
  ...
  const handleDeleteReminderCancel = () => setReminderPendingDelete(null);

  const handleDeleteReminderConfirm = () => {
    if (!reminderPendingDelete) return;
    ...
    >
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <div style={{ display: "flex", gap: "8px", marginTop: "8px", flexWrap: "wrap" }}>
                                    ...
                                    <button
                                      type="button"
                                      onClick={() => setReminderPendingDelete(reminder)}
                                      style={{
      ...
      {reminderPendingDelete && (
        <div
          ...
          onClick={handleDeleteReminderCancel}
        >
          <div
            style={{
              backgroundColor: "var(--bg-secondary)",
            ...
            role="dialog"
            aria-modal="true"
            aria-labelledby="calendar-delete-reminder-title"
          >
            <h3
              id="calendar-delete-reminder-title"
              style={{
                fontSize: "18px",
                fontWeight: "600",
                marginBottom: "12px",
            ...
            >
              {reminderPendingDelete.type === "task" ? "Delete Task" : "Delete Reminder"}
            </h3>
            <p
              style={{
                fontSize: "14px",
            ...
            >
              ...
              <strong>&quot;{(reminderPendingDelete.title ?? "").trim() || "this item"}&quot;</strong>?
            </p>
            <p
              style={{
                fontSize: "13px",
            ...
            >
              ...
              <button
                type="button"
                onClick={handleDeleteReminderConfirm}
                style={{
