...
const FILTER_KEYS = [
  "tradebutler_analytics_filter_strategy",
  "tradebutler_analytics_filter_symbol",
  "tradebutler_analytics_filter_side",
  "tradebutler_analytics_filter_type",
  "tradebutler_analytics_filter_position_size",
];
...
export class AnalyticsErrorBoundary extends Component<Props, State> {
  ...
  clearFiltersAndRetry = () => {
    ...
    this.setState({ hasError: false, error: null, remountKey: (s) => s.remountKey + 1 });
  };
