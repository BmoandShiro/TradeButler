      ...
      if (shouldSaveSurvey && firstStateId != null) {
        try {
          await invoke("add_emotion_survey", {
            ...
            timestamp,
            beforeCalmClear: surveyResponses.before_calm_clear ?? 6,
            beforeUrgencyPressure: surveyResponses.before_urgency_pressure ?? 6,
            beforeConfidenceVsValidation: surveyResponses.before_confidence_vs_validation ?? 6,
            beforeFomo: surveyResponses.before_fomo ?? 6,
            beforeRecoveringLoss: surveyResponses.before_recovering_loss ?? 6,
            beforePatientDetached: surveyResponses.before_patient_detached ?? 6,
            beforeTrustProcess: surveyResponses.before_trust_process ?? 6,
            beforeEmotionalState: surveyResponses.before_emotional_state ?? 6,
            duringStable: surveyResponses.during_stable ?? 6,
            duringTensionStress: surveyResponses.during_tension_stress ?? 6,
            duringTemptedInterfere: surveyResponses.during_tempted_interfere ?? 6,
            duringNeedControl: surveyResponses.during_need_control ?? 6,
            duringFearLoss: surveyResponses.during_fear_loss ?? 6,
            duringExcitementGreed: surveyResponses.during_excitement_greed ?? 6,
            duringMentallyPresent: surveyResponses.during_mentally_present ?? 6,
            afterAcceptOutcome: surveyResponses.after_accept_outcome ?? 6,
            afterEmotionalReaction: surveyResponses.after_emotional_reaction ?? 6,
            afterConfidenceAffected: surveyResponses.after_confidence_affected ?? 6,
            afterTemptedAnotherTrade: surveyResponses.after_tempted_another_trade ?? 6,
            afterProudDiscipline: surveyResponses.after_proud_discipline ?? 6,
          });
        } catch (error) {
