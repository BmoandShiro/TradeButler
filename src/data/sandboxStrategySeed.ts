...
function buildStrategyChecklistItems(): SandboxChecklistItem[] {
  ...
  for (const strategyId of strategyIds) {
    ...
    if (strategyId === 1) {
      ...
      const s1 = [ci(strategyId, "How calm/clear before entry? (1-5)", 0, "survey", true, null, true), ci(strategyId, "How confident in setup? (1-5)", 1, "survey", true, null, true), ci(strategyId, "Urgency to enter? (1-5)", 2, "survey", true, null, false)];
      items.push(...s1);
      ...
      const s2 = [ci(strategyId, "Patience level (1-5)", 0, "survey", true, null, true), ci(strategyId, "FOMO level (1-5)", 1, "survey", true, null, false), ci(strategyId, "Discipline to wait (1-5)", 2, "survey", true, null, true)];
      items.push(...s2);
      ...
      const s4 = [ci(strategyId, "Speed of decision (1-5)", 0, "survey", true, null, true), ci(strategyId, "Emotional control (1-5)", 1, "survey", true, null, true), ci(strategyId, "Follow-through (1-5)", 2, "survey", true, null, true)];
      items.push(...s4);
      ...
      const s5 = [ci(strategyId, "Patience to hold (1-5)", 0, "survey", true, null, true), ci(strategyId, "Conviction in thesis (1-5)", 1, "survey", true, null, true), ci(strategyId, "Avoided early exit (1-5)", 2, "survey", true, null, true)];
      items.push(...s5);
      ...
      const s6 = [ci(strategyId, "Fade discipline (1-5)", 0, "survey", true, null, true), ci(strategyId, "No revenge (1-5)", 1, "survey", true, null, true), ci(strategyId, "Execution calm (1-5)", 2, "survey", true, null, true)];
      items.push(...s6);
