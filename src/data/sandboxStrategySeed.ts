...
function buildStrategyChecklistItems(): SandboxChecklistItem[] {
  ...
  for (const strategyId of strategyIds) {
    ...
    if (strategyId === 1) {
      ...
      const s1 = [ci(strategyId, "How calm/clear before entry? (1-10)", 0, "survey", true, null, true), ci(strategyId, "How confident in setup? (1-10)", 1, "survey", true, null, true), ci(strategyId, "Urgency to enter? (1-10)", 2, "survey", true, null, false), ci(strategyId, "Trust in process (1-10)", 3, "survey", true, null, true)];
      items.push(...s1);
      ...
      const s2 = [ci(strategyId, "Patience level (1-10)", 0, "survey", true, null, true), ci(strategyId, "FOMO level (1-10)", 1, "survey", true, null, false), ci(strategyId, "Discipline to wait (1-10)", 2, "survey", true, null, true), ci(strategyId, "Pullback mindset (1-10)", 3, "survey", true, null, true)];
      items.push(...s2);
      ...
      const s3 = [ci(strategyId, "Calm before trade (1-10)", 0, "survey", true, null, true), ci(strategyId, "Greed/fear balance (1-10)", 1, "survey", true, null, true), ci(strategyId, "Stick to plan (1-10)", 2, "survey", true, null, true), ci(strategyId, "Post-trade clarity (1-10)", 3, "survey", true, null, true)];
      items.push(...s3);
      ...
      const s4 = [ci(strategyId, "Speed of decision (1-10)", 0, "survey", true, null, true), ci(strategyId, "Emotional control (1-10)", 1, "survey", true, null, true), ci(strategyId, "Follow-through (1-10)", 2, "survey", true, null, true), ci(strategyId, "Execution calm (1-10)", 3, "survey", true, null, true)];
      items.push(...s4);
      ...
      const s5 = [ci(strategyId, "Patience to hold (1-10)", 0, "survey", true, null, true), ci(strategyId, "Conviction in thesis (1-10)", 1, "survey", true, null, true), ci(strategyId, "Avoided early exit (1-10)", 2, "survey", true, null, true), ci(strategyId, "Scale-out discipline (1-10)", 3, "survey", true, null, true)];
      items.push(...s5);
      ...
      const s6 = [ci(strategyId, "Fade discipline (1-10)", 0, "survey", true, null, true), ci(strategyId, "No revenge (1-10)", 1, "survey", true, null, true), ci(strategyId, "Execution calm (1-10)", 2, "survey", true, null, true), ci(strategyId, "Mean reversion patience (1-10)", 3, "survey", true, null, true)];
      items.push(...s6);
